...
#미션 리스트
MISSION_LIST = [0,25,16,0,24,0,24,15,17,26] ### tryout  tryout  tryout  tryout  tryout  tryout  tryout  tryout  tryout  tryout  tryout  

#미션 딕셔너리
MISSION_DIC = {0:'고속',7:'배달A',9:'배달B',11:'정적소형',12:'정적대형',14:'평행주차',15:'터널',16:'유턴',17:'터널동적',21:'정지선 직진',22:'정지선 좌회전',23:'정지선 우회전',24:'감속구간',25:'방지턱',26:'중속'}

#맵 가져올 경로
CURRENT_FILE_PATH = os.path.abspath(__file__)
CURRENT_DIRECTORY = os.path.dirname(CURRENT_FILE_PATH)
GLOBAL_UTM_TXT_ADDRESS = CURRENT_DIRECTORY + "/map_tryout/"
...
class Planning(Node):
    ...
    def __init__(self):
        ...
        self.prl_k = None
        self.prl_tree = None
        self.prl_R1 = 2.9 # 작은원 (안쪽)            튜닝필수!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.prl_R2 = 3.5 # 큰원 (바깥쪽)          튜닝필수!!!!!!!!!!!!!!!!!!!!!!!!!!             
        self.offset_D = 1.4 # 스타트점 세로로 offset하는 값       튜닝필수!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.offset_short = 0 # 가로로 띄움      쓰지마ㅋㅋ
        self.offset_gap = 1.1 # 호 두개 띄움     튜닝필수!!!!!!!!!!!!!!!!!!!!!!!!!!
        self.esc_D = 6 # 탈출경로 만드는 거리 (m)  튜닝필수!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        self.timer_period = 0.01  # 루프 주기를 1초로 설정 (1 Hz)
